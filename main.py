...
#
# ELMO DA FÚRIA:
#   Descrição e narração atualizados. Ao equipar: mensagem de
#   cabeçada/investida. Ao atacar com bônus ativo: linha de ação
#   aleatória ("Cabeçada brutal!", "Investida agressiva!", etc.).
#   Ao expirar: "Os chifres do Elmo se partiram no impacto!"
#   Efeito registrado em efeitos_ativos['elmo_furia'] (1 ataque).
#
...
DESCRICOES_ITENS = {
    ...
    'Elmo da Fúria':            "Capacete cravado de chifres afiados. Cabeçadas e investidas causam dano extra. -1 CA.",
...
""")
    ...
    def _sessao_zero(self, personagem, classe):
        ...
        if sc == 'Bárbaro':
            ...
            op_extra = [
                "Elmo da Fúria +2 — cabeçadas brutais e bônus de ataque, -1 CA",
